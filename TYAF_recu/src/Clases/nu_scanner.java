...
//            CvSeq sign = cvHaarDetectObjects(img,cascade,storage,1.05,3,CV_HAAR_DO_CANNY_PRUNING);
//            cvClearMemStorage(storage);
//            int total_bodies = sign.total(); 
//            System.out.println(src +": " + total_bodies);
//        }
//        catch(Exception e){}
//    }
